...
local item = {
	...
	entity = CollectibleType.COLLECTIBLE_SHARP_PLUG,
	Addlist = {
	},
}
...
Function = function(_,ent,amt,flag,source,cooldown)
	...
	if player and flag & 33826849 == 33826849 and auxi.has_have_coll(player,item.entity) then		--33826849 = 25+18+13+11+5+0
