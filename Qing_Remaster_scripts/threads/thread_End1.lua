...
local item = {
	...
	Words = {
		...
		en = {
            ...
            {word = "Wan Qing flew through the air, thrusting his dagger fiercely at the calamity beast.",},
            ...
            {word = "Amidst the colorful rays of light, Glaze turned his head and smiled at Wan Qing.",},
            {word = "This demon beast shall be mine to claim!",},
            {word = "And to think, there's also this unexpected bonus...", cut = true,},
            {word = "Damn it.. Wan Qing stared intently at Glaze.",},
            {word = "That's my arch-nemesis, Prince Glaze.",},
            {word = "I must strike first!",},
            {word = "In the blink of an eye, Wan Qing's flying blade was already suspended above Glaze's head!",},
            ...
            {word = "Isaac!! Wan Qing's pupils dilated. You————", cut = true,},
